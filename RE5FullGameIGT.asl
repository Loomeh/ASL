/***************************** Created by Austin 'Auddy' Davenport | Some values found by Dread & Wipefinger ******************************************/
...
state("RE5DX10")
{
	int levelNumberGFWL : 0xE79ED0, 0x21EF0;  //GFWL DX10
	float igtGFWL : 0xE79ED0, 0x21F30;  //GFWL DX10
}
